...
const Testimonials = () => {
  ...
  return (
    <section id="impact" ref={containerRef} className="py-24 bg-zinc-900 text-white overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full bg-blue-600/10 -skew-x-12 transform translate-x-20 pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((item, idx) => (
                <div key={idx} className="testimonial-card bg-zinc-800/50 backdrop-blur-sm p-8 rounded-2xl border border-zinc-700 hover:border-blue-500/50 transition-colors">
                    <Quote className="text-blue-500 mb-6 w-10 h-10 opacity-50" />
