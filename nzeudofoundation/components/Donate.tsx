...
const Donate = () => {
  return (
    <section id="donate" className="py-24 relative overflow-hidden bg-blue-600 flex items-center justify-center text-center">
       ...
       <div className="container mx-auto px-6 relative z-10 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                    href="#" 
                    className="px-8 py-5 bg-white text-blue-600 rounded-full font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-2"
                >
                    Donate Now <ArrowRight className="w-5 h-5" />
                </Link>
                <Link 
                    href="#contact" 
                    className="px-8 py-5 bg-blue-700/50 text-white border border-blue-400/30 rounded-full font-bold text-lg hover:bg-blue-700 transition-all backdrop-blur-sm"
                >
                    Become a Partner
                </Link>
            </div>
