    ...
    return (
        <div className="bg-white pb-20">
            ...
            <div className="container mx-auto px-6 -mt-20 relative z-20">
                <div className="bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100 flex flex-col lg:flex-row">
                        ...
                        <form className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="relative">
                                    <input
                                        type="text"
                                        id="firstName"
                                        className="peer w-full border-b-2 border-gray-200 bg-transparent py-2.5 placeholder-transparent focus:border-blue-600 focus:outline-none"
                            ...
                            <div className="relative">
                                <textarea
                                    id="message"
                                    rows={4}
                                    className="peer w-full border-b-2 border-gray-200 bg-transparent py-2.5 placeholder-transparent focus:border-blue-600 focus:outline-none resize-none"
                                    placeholder="Message"
                                />
                            ...
                            <button type="button" className="w-full py-4 bg-gray-900 text-white font-bold rounded-xl hover:opacity-90 transition-opacity shadow-sm">
                                Send Message
                            </button>
                        </form>
                    </div>
