    ...
    return (
        <div ref={containerRef} className="bg-white pb-20">
            ...
            <div className="container mx-auto px-6 -mt-20 relative z-20 space-y-24">
                ...
                {/* Founder Section */}
                <div className="reveal-section bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col md:flex-row gap-12 items-center">
                    <div className="w-full md:w-2/5 shrink-0">
                        <div className="relative aspect-3/4 rounded-2xl overflow-hidden shadow-sm border-4 border-white">
                            <Image
                                src={NzeudoLogo}
                    ...
                    <div className="w-full md:w-3/5">
                        <h2 className="text-3xl font-bold text-gray-900 mb-6 heading-text">The Visionary Behind NEF</h2>
                        <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                            ...
                            <p>
                                Beyond his professional accolades, Nze Osuagwu is a dedicated humanitarian who firmly believes that <span className="italic text-gray-900 font-medium">"education is the harbinger of human capital development."</span>
                            </p>
                            <div className="flex items-start gap-4 p-6 bg-green-50 rounded-2xl border border-green-100">
                                ...
                                <div>
                                    <p className="italic text-gray-700 font-medium mb-3">
                ...
                <div className="reveal-section grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <h3 className="text-2xl font-bold heading-text text-gray-900 mb-4">Our Mission</h3>
                        <p className="text-gray-600 leading-relaxed">
                            To serve as a platform for supporting <strong className="text-gray-900">indigent but brilliant children</strong> who have lost their family breadwinner. We focus on the voiceless, the downtrodden, and the neglected, providing them the means to access quality education.
                        </p>
                    </div>
                    <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <h3 className="text-2xl font-bold heading-text text-gray-900 mb-4">Our Vision</h3>
                        <p className="text-gray-600 leading-relaxed">
                ...
                <div className="reveal-section max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl font-bold heading-text text-gray-900 mb-8">Our Journey So Far</h2>
                ...
                <div className="reveal-section space-y-12">
                    <div className="text-center max-w-2xl mx-auto">
                        <div className="inline-flex items-center gap-2 mb-4 text-green-600 bg-green-50 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider">
                            <Users size={16} /> OUR LEADERSHIP
                        </div>
                        <h2 className="text-4xl font-bold heading-text text-gray-900">Meet Our Board</h2>
                    ...
                    <div className="team-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="team-card flex items-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-sm hover:border-green-200 transition-all duration-300 group">
                                ...
                                <div>
                                    <h4 className="font-bold heading-text text-gray-900 group-hover:text-green-600 transition-colors text-lg leading-tight mb-1">{member.name}</h4>
