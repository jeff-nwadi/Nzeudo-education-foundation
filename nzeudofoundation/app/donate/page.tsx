            ...
            <div className="container mx-auto px-6 -mt-24 relative z-20">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                        ...
                        {/* Bank Transfer Card */}
                        <div className="bg-white rounded-3xl p-10 shadow-sm border border-blue-100 hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden group">
                        ...
                        {/* In-Kind Card */}
                        <div className="bg-white rounded-3xl p-10 shadow-sm border border-purple-100 hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden group">
                            ...
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <h2 className="text-2xl font-bold text-gray-900 heading-text">In-Kind Donations</h2>
                            </div>
                            ...
                            <a href="tel:+2341234567890" className="block w-full py-4 bg-gray-900 text-white font-bold text-center rounded-xl hover:opacity-90 transition-opacity">
                    ...
                    <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100 text-center">
                        <h3 className="text-2xl font-bold text-gray-900 mb-8 heading-text">Where Your Money Goes</h3>
